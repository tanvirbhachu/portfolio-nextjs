        ...
        <div className='lg:w-1/2 lg:sticky max-w-5xl p-10'>
            <div className="mb-5 mt-20">
                ...
                <p className="text-neutral-400 mb-4 text-base" data-aos="fade-right" data-aos-delay="100">I’m a web developer and UX architect. My
                    superpower? I create digital magic. Although I have been programming for over 6 years, I mostly
            ...
            <div className="mb-5">
                ...
                <div className="flex flex-row gap-2 max-w-xs text-neutral-400" data-aos="fade-right" data-aos-delay="350">
