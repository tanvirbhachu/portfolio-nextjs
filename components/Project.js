...
export default function Project({url, id, title, description, tailwind, javascript, react, netlify, api, next, sanity, mongo, vercel}) {
    return (
        <Link href={url} target="_blank" rel="noreferrer">
            <a id={id} className="project block cursor-none bg-[#101010] w-full p-6 hover:bg-[#212121] transition hover:scale-105 md:border-[#101010] border-[#212121] border-2 hover:border-indigo-600">
