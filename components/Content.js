                ...
                <div className='space-y-5'>
                    <div>
                        <div className='animate__animated animate__slideInRight'>
                            <a href="https://veritas-tanvirbhachu.vercel.app/?page=1" target="_blank" rel="noreferrer"
                                ...
                                <h3 className="text-2xl mb-2 text-white">Veritas</h3>
                                <p className="text-neutral-400 text-sm">Veritas is social media platform I built from scratch. It has a fully 
                                ...
                                <div className="flex flex-wrap flex-grow gap-2 mt-4">
                                    ...
                                    <span className="bg-yellow-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">React</span>
                                    <span className="bg-yellow-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">NextJS</span>
                                    <span className="bg-red-100 text-yellow-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">SanityCMS</span>
                                    <span className="bg-red-100 text-emerald-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">MongoDB</span>
                                    <span className="bg-cyan-100 text-purple-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">Vercel</span>
                                </div>
                            </a>
                        </div>
                    </div>
